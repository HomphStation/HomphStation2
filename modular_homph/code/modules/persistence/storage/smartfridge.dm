...
/datum/persistent/storage/smartfridge/sheet_storage/lossy
	...
	max_storage = 10000	//if the amount is above this, cull it to this amount THEN do math //CHOMPedit: Altering how many items can be held between rounds.
	stacks_go_missing = FALSE
...
/datum/persistent/storage/smartfridge/produce/lossy
	...
	go_missing_chance = 0 // 0% loss chance between rounds
