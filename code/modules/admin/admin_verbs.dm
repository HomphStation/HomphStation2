...
/client/proc/rename_silicon()
	...
	var/mob/living/silicon/S = tgui_input_list(usr, "Select silicon.", "Rename Silicon.", GLOB.silicon_mob_list) // CHOMPEdit - Globals
	if(!S) return
...
/client/proc/manage_silicon_laws()
	...
	var/mob/living/silicon/S = tgui_input_list(usr, "Select silicon.", "Manage Silicon Laws", GLOB.silicon_mob_list) // CHOMPEdit - Globals
	if(!S) return
